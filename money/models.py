...
#    id_entidadesbancarias = models.ForeignKey('Entidadesbancarias', models.DO_NOTHING, db_column='id_entidadesbancarias', blank=True, null=True)
...
#
#
#class Entidadesbancarias(models.Model):
#    id_entidadesbancarias = models.AutoField(primary_key=True)
#    entidadbancaria = models.TextField()
#    active = models.BooleanField()
#
#    class Meta:
#        managed = False
#        db_table = 'entidadesbancarias'
#
#
